...
public class MyAdapter extends
    ...
    Context context;
    int singledata;
    ArrayList<com.example.pertemuan8_sqlite.Model>modelArrayList;
    SQLiteDatabase sqLiteDatabase;
    //generate constructor
    public MyAdapter(Context context, int singledata,
                     ArrayList<com.example.pertemuan8_sqlite.Model> modelArrayList, SQLiteDatabase sqLiteDatabase) {
    ...
    public void onBindViewHolder(@NonNull MyAdapter.ViewHolder
        ...
        final com.example.pertemuan8_sqlite.Model model = modelArrayList.get(position);
                    ...
                    public boolean onMenuItemClick(MenuItem item)
                    {
                        switch (item.getItemId()){
                            ...
                            case R.id.delete_menu:
                                //delete operation
                                com.example.tugasrecycleview.DBmain dBmain = new
                                        com.example.tugasrecycleview.DBmain(context);
                                sqLiteDatabase =
